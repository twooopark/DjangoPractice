...
#### 2.12 Get 방식 처리 방식 변화... django 1.8 버전 이후로 바뀜
```
...
참고) https://github.com/tschellenbach/Django-facebook/pull/564/commits/32f5a0c13add2e2699becbe1459bab803ff313f2
```

#### 2.13 Guestbook 삭제 동작 방식
```
index.html > 삭제 >  deleteform.html?name=... (GET방식) >
 views.deleteform > rendering > password 입력 > 확인 (POST방식) >
 views.delete > POST로 받은 Guestbook과 model에서 받은 Instance를 비교 >
 일치하면 삭제.
```